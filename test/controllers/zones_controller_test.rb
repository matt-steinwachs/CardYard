...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { game_id: @zone.game_id, user_id: @zone.user_id, zone_data: @zone.zone_data }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { game_id: @zone.game_id, user_id: @zone.user_id, zone_data: @zone.zone_data }
    assert_redirected_to zone_path(assigns(:zone))
  end
